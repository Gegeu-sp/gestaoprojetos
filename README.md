...
<p align="center">
  ...
  <img src="https://img.shields.io/github/license/Gegeu-sp/gestaoprojetos" alt="Licença">
  <img src="https://img.shields.io/github/languages/top/Gegeu-sp/gestaoprojetos" alt="Linguagem Principal">
</p>
...
<div align="center">
  <img src="screenshot.png" alt="Demonstração do projeto" width="700"/>
</div>
...
O **Gestão de Projetos** é uma ferramenta criada para simplificar a organização de tarefas e equipes. A plataforma permite o cadastro de projetos, a definição de tarefas com prazos e a atribuição de responsáveis, oferecendo um dashboard intuitivo para acompanhar o andamento de todas as atividades.

## ✨ Funcionalidades Principais

- **✔️ Criação de Projetos:** Defina um escopo, datas e objetivos para cada projeto.
- **✔️ Kanban Board:** Visualize tarefas em colunas de "A Fazer", "Em Andamento" e "Concluído".
- **✔️ Atribuição de Responsáveis:** Desempenhe membros da equipe para tarefas específicas.
- **✔️ Interface Limpa e Intuitiva:** Foco na usabilidade para uma gestão sem complicações.
...
|-----------|-----------|
| **Frontend** | `[Ex: React.js, Vite, TypeScript, TailwindCSS]` |
| **Backend** | `[Ex: Node.js, Express, Prisma]` |
...
$ git clone [https://github.com/Gegeu-sp/gestaoprojetos.git](https://github.com/Gegeu-sp/gestaoprojetos.git)
...
* **Desenvolvimento Backend:**
    ...
    * **Tecnologias:** `[Ex: Node.js, Express, etc.]`
...
* **Desenvolvimento Frontend:**
    ...
    * **Tecnologias:** `[Ex: HTML5, CSS3, JavaScript, React, etc.]`
...
* **Modelagem e Banco de Dados:**
    ...
    * **Tecnologias:** `[Ex: PostgreSQL, SQLite, etc.]`
